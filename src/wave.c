...
MAYBE_UNUSED inline static void to_little_endian(uint8_t* data, size_t len)
{
#if !IS_LITTLE_ENDIAN
...
MAYBE_UNUSED inline static void from_little_endian(uint8_t* data, size_t len)
{
#if !IS_LITTLE_ENDIAN
	swap_endianness(data, len);
#endif
...
MAYBE_UNUSED inline static void to_big_endian(uint8_t* data, size_t len)
{
#if IS_LITTLE_ENDIAN
	swap_endianness(data, len);
#endif
...
MAYBE_UNUSED inline static void from_big_endian(uint8_t* data, size_t len)
{
#if IS_LITTLE_ENDIAN
	swap_endianness(data, len);
#endif
